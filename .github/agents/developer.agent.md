...
- `docs/dev/ARCHITECTURE.md` — component boundaries and data flow
- `docs/dev/IR.md` — IR types and conversion pipeline
...
- Verify the target files and module boundaries align with `ARCHITECTURE.md`
