...
class TestExportSmokeLoop:
    """torch.export round-trip parity for Loop graph."""

    def test_export_roundtrip(self) -> None:
        """Exported Loop graph must match eager output."""
        assert_export_roundtrip(
            _make_loop_model(),
            {
...
class TestExportSmokeScan:
    """torch.export round-trip parity for Scan graph."""

    def test_export_roundtrip(self) -> None:
        """Exported Scan graph must match eager output."""
        assert_export_roundtrip(
            _make_scan_model(),
            {
