"""NLP model family parity tests (BERT, RoBERTa, DistilBERT, GPT-2)."""
...
class TestGPT2Parity:
    """End-to-end ORT vs ProtoFX parity for GPT-2."""

    def test_gpt2_parity(self, tmp_path: Path) -> None:
        """GPT-2 manifest must produce numerically close ORT and ProtoFX outputs."""
